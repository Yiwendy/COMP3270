   ...
   public static class TrieAutocomplete implements Autocompletor {
      ...
      private void add(String word, double weight) {
         ...
         for(char chars: word.toCharArray()){
            ...
            Node child = currentNode.getChild(chars);
                
            if(child == null){
               child = new Node(chars, currentNode, weight);
               currentNode.children.put(chars, child);
            }
            currentNode = child;
         }
      ...
      public Iterable<String> topMatches(String prefix, int k) {
         ...
         for(char chars: prefix.toCharArray()) {
            
            if(currentNode.getChild(chars) == null){
               return new ArrayList<String>();
            }
            currentNode = currentNode.getChild(chars);
         }
      ...
      public double weightOf(String term) {
         ...
         // New node that currently points to the root node.
         Node currentNode = myRoot;
         for (char chars : term.toCharArray()) {
